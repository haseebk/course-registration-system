...
public class CourseCatalog extends JPanel {
	 ...
	 * @param theList 
	 */
	public CourseCatalog(JFrame frame, DefaultListModel<String> theList) {

//	public CourseCatalog(JFrame frame, StandardUserHome homePanel, DefaultListModel<String> theList) {
		setLayout(null);
		...
		add(scrollPane);
//		scrollPane.setBorder(new LineBorder(Color.RED, 5, true));

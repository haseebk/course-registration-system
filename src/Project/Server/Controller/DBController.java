...
public class DBController {
	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			...
			case 1:
				// Search catalog
				controller.communicator.communicateWithClient(
						controller.backend.searchCatalogue(data.get(1), Integer.parseInt(data.get(2))));
				break;
			case 2:
				// Add course
				controller.backend.addCourse(data.get(1), data.get(2), Integer.parseInt(data.get(3)),
						Integer.parseInt(data.get(4)));
				break;
			case 3:
				// Remove course
				controller.communicator.communicateWithClient(
						controller.backend.removeCourse(data.get(1), data.get(2), Integer.parseInt(data.get(3))));
				break;
			case 4:
				// View Course catalog
			...
			case 6:
				...
				case 1:
					...
					controller.communicator.communicateWithClient(
							controller.backend.courseExist(data.get(2), Integer.parseInt(data.get(3))));
					break;
				case 2:
					if (data.size() < 3) {
						controller.communicator.communicateWithClient("1");
				...
				case 4:
					...
					break;
				case 5:
					controller.communicator.communicateWithClient(controller.backend.canEnroll(data.get(2), data.get(3),
